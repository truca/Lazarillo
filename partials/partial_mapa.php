<div style="height: 35px; width: 150px; z-index: 999999; position: absolute;margin-left: 50%;left: -75px;bottom: 70px;">
	<div class="btn-group">
	  <button id="bajar" type="button" ng-click="cambiarPiso('-')" class="btn btn-default">Bajar</button>
	  <button type="button" disabled class="btn btn-default">{{pisoActual}}</button>
	  <button id="subir" type="button" ng-click="cambiarPiso('+')" class="btn btn-default">Subir</button>
	</div>
</div>
