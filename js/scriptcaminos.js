...
//conviente la posicion actual del usuario en el formato de adyacencia
function adyacente_usuario(punto,grafo_posiciones,pt,nivel)
{
var subgrafo=grafo_posiciones;//aqui hare mi magia despues
var adyacente=new Array();
adyacente[0]=-1;
adyacente[1]=new Array();
adyacente[1][0]=new Array();
adyacente[1][0][0]=nodo_distancia_menor(punto,subgrafo);
adyacente[1][0][1]=0;
return adyacente;
}
